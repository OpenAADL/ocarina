...
sys.path.insert(0, os.path.abspath('../resources/runtime/python'))
...
def get_copyright():
    return u'2003-2009 Telecom ParisTech, 2009-%s ISAE, ESA' % time.strftime("%Y")
...
def get_version():
    ...
    for line in file("../configure.ac").readlines():
...
man_pages = [
    ('index', 'ocarina', u'Ocarina Documentation',
     [u'Jerome Hugues'], 1)
]
...
texinfo_documents = [
  ('index', 'ocarina', u'Ocarina Documentation',
   u'Jerome Hugues', 'Ocarina', 'AADL model processing toolsuite',
   'Miscellaneous'),
]
