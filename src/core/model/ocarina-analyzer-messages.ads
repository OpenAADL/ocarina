...
package Ocarina.Analyzer.Messages is
   ...
   procedure DAE
     (Node1    : Node_Id;
      ...
      Message0 : String   := "";
      Loc      : Location := No_Location)
     renames Display_Analyzer_Error;
   ...
   procedure DCD
     (Loc1 : Location;
      ...
      Name : Name_Id;
      Loc2 : Location)
     renames Display_Conflict_Declaration;
   ...
   procedure DCD (Node1 : Node_Id; Node2 : Node_Id)
     renames Display_Conflict_Declaration;
   --  Display an output error message:
   ...
   procedure DUI
     (Loc  : Location;
      Kind : Ocarina.Me_AADL.AADL_Tree.Nodes.Node_Kind;
      Name : Name_Id)
     renames Display_Undefined_Item;
   --  Display an output error message:
   ...
   procedure DUI (Kind : Ocarina.Me_AADL.AADL_Tree.Nodes.Node_Kind;
                  Item : Node_Id)
     renames Display_Undefined_Item;
   --  Display an output error message:
   ...
   procedure DUT
     (Expected_Type : Ocarina.Me_AADL.AADL_Tree.Nodes.Node_Kind;
      ...
      Item          : Node_Id;
      Loc           : Location)
     renames Display_Unexpected_Type;
   --  Display an output error message:
   ...
   procedure DUCC
     (Expected_Cat : Ocarina.Me_AADL.Component_Category;
      ...
      Item         : Node_Id;
      Loc          : Location)
     renames Display_Unexpected_Component_Category;
   --  Display an output error message:
   ...
   procedure DLTWN
     (Node         : Node_Id;
      ...
      Warning      : Boolean := False;
      Non_Existent : Boolean := False)
     renames Display_Link_To_Wrong_Node;
   ...
   function Display_Node_Kind_Error (Node : Node_Id) return Boolean
     renames Ocarina.Me_AADL.AADL_Tree.Entities.Display_Node_Kind_Error;

   function DNKE (Node : Node_Id) return Boolean
     renames Ocarina.Me_AADL.AADL_Tree.Entities.Display_Node_Kind_Error;
