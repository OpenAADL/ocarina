...
--                           OCARINA COMPONENTS                             --
--                                                                          --
--               OCARINA.BACKENDS.ARINC653_CONF.CONNECTIONS                 --
--                                                                          --
--                                 B o d y                                  --
--                                                                          --
...
package body Ocarina.Backends.ARINC653_Conf.Connections is
      ...
      if not AINU.Is_Empty (Subcomponents (E)) then
         ...
         while Present (S) loop
            ...
            if AINU.Is_Processor (Corresponding_Instance (S)) then
               ...
               --  Current_XML_Node is still defined in the visited
...
end Ocarina.Backends.ARINC653_Conf.Connections;
