...
package body Ocarina.Backends.Cheddar.Mapping is
   ...
   begin
      ...
      if Dispatch = Thread_Sporadic
        or else Dispatch = Thread_Periodic
      then
   ...
   begin
      ...
      --  cpu_name: computed from the processor binding of the
      --  container process of the current thread
      K := Map_Node_Identifier_To_XML_Node
        ("cpu_name",
         Parent_Subcomponent
           (Get_Bound_Processor
              (Corresponding_Instance
