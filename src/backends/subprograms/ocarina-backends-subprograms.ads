...
package Ocarina.Backends.Subprograms is

   type Subprograms_Generation_Kind is (Ada, C);
   --  Only C are handled at this time.

   Current_Generation_Kind : Subprograms_Generation_Kind := C;
...
private
   C_Root : Node_Id;
   --  The root of the C tree that can be generated.
