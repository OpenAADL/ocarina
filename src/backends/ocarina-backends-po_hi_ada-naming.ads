...
--  PolyORB_HI_Generated.Naming package that contains the naming table
--  that allows to send to an receive messages from a given node.

package Ocarina.Backends.PO_HI_Ada.Naming is
