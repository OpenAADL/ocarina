...
with Ocarina.Backends.XML_Tree.Debug; use Ocarina.Backends.XML_Tree.Debug;

package body Ocarina.Backends.XML_Tree.Nodes is
   ...
   begin
      pragma Assert (False
        ...
        or else Table (Types.Node_Id (N)).Kind = K_XML_Comment
        ...
        or else Table (Types.Node_Id (N)).Kind = K_XML_File
        or else Table (Types.Node_Id (N)).Kind = K_XML_Node
   ...
   function XML_DTD (N : Node_Id) return Node_Id is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_XML_File);
   ...
   procedure Set_XML_DTD (N : Node_Id; V : Node_Id) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_XML_File);
   ...
   function XML_File (N : Node_Id) return Node_Id is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_HI_Unit);
   ...
   procedure Set_XML_File (N : Node_Id; V : Node_Id) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_HI_Unit);
   ...
   procedure W_XML_Comment (N : Node_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
   ...
   procedure W_XML_File (N : Node_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
   ...
   procedure W_XML_Node (N : Node_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
