...
--                                 S p e c                                  --
--                                                                          --
--                    Copyright (C) 2010-2020 OpenAADL                      --
--                                                                          --
...
package Ocarina.Backends.MAST_Values is
   ...
   function To_MAST_Value (V : Value_Id) return Value_Id;
   --  Converts an AADL value to an MAST one
