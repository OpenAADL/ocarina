...
package Ocarina.Backends.RTSJ_Tree.Nutils is
   ...
   Operator_Image : array
         (Operator_Type'Pos (Op_Not) ..  Operator_Type'Pos (Op_Vertical_Bar))
     of Name_Id;

   subtype Keyword_Operator is Operator_Type
     range Operator_Type'First .. Op_Or;
   ...
   function Add_Suffix_To_Name (Suffix : String; Name : Name_Id)
                               return Name_Id;
   procedure Add_Import (E : Node_Id);
   function To_RTSJ_Conventional_Name (Name : Name_Id; Is_Obj : Boolean)
                                 return Name_Id;
