...
--  <Node>_Deployment package that contains deployment information on
--  the distributed application "seen" by a given node

package Ocarina.Backends.PO_HI_C.Deployment is
