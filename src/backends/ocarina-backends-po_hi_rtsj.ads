...
--  This is the root unit for the Java code generator to the PolyORB-HI
--  middleware.

package Ocarina.Backends.PO_HI_RTSJ is
   ...
   procedure Reset;
   --  Reset the internal units of the PO_HI_Java generator

private
   RTSJ_Root : Node_Id;
   --  The root of the Java trees
