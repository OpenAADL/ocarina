...
--  This is the root unit for the Ada code generator to the
--  PolyORB-QoS middleware.

package Ocarina.Backends.PO_QoS_Ada is

   procedure Generate (AADL_Root : Node_Id);
   --  The main entry point of the Ada PolyORB-QoS code
   --  generator. AADL is the node tree of an AADL model instance.
   ...
   procedure Reset;
   --  Reset the internal units of the PO_QoS_Ada generator
